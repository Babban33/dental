...
function Phenotype({onPredictionChange}){
    ...
    return (
        <div>
            <h1 className="font-serif text-4xl font-bold text-indigo-600 leading-tight">{content["pages"][language].pheno}</h1>
            ...
            {capturedPhoto && (
                <div className="mt-4 flex flex-col md:flex-row space-y-4 md:space-x-4 items-center">
                    ...
                    <div className="flex flex-col space-y-2 items-start">
                        ...
                        <button onClick={checkPheno} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full flex">
            ...
            <div className="justify-center gap-4 mt-4 grid grid-cols-2">
                ...
                <NavButton text={content["Nav"][language].btn2} destination="/calculus" />
            </div>
        </div>
    )
}
